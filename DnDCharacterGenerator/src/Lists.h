...
namespace dnd {
	...
	// Nonhuman name constants
	const int NumDwarfClanNames = 15;
	const int NumDwarfFemaleNames = 23;
	const int NumDwarfMaleNames = 30;

	const int NumElfFamilyNames = 10;
	const int NumElfFemaleNames = 30;
	const int NumElfMaleNames = 29;

	const int NumHalflingFamilyNames = 10;
	const int NumHalflingFemaleNames = 18;
	const int NumHalflingMaleNames = 17;

	// Human name constants
	const int NumCalishiteSurnames = 7;
	const int NumChondathanTethyrianSurnames = 6;
	const int NumDamaranSurnames = 8;
	const int NumIlluskanSurnames = 6;
	const int NumMulanSurnames = 7;
	const int NumRashemiSurnames = 6;
	const int NumShouSurnames = 12;
	const int NumTuramiSurnames = 8;

	const int NumCalishiteFemaleNames = 8;
	const int NumChondathanTethyrianFemaleNames = 9;
	const int NumDamaranFemaleNames = 8;
	const int NumIlluskanFemaleNames = 8;
	const int NumMulanFemaleNames = 9;
	const int NumRashemiFemaleNames = 8;
	const int NumShouFemaleNames = 8;
	const int NumTuramiFemaleNames = 9;

	const int NumCalishiteMaleNames = 7;
	const int NumChondathanTethyrianMaleNames = 10;
	const int NumDamaranMaleNames = 11;
	const int NumIlluskanMaleNames = 11;
	const int NumMulanMaleNames = 9;
	const int NumRashemiMaleNames = 8;
	const int NumShouMaleNames = 13;
	const int NumTuramiMaleNames = 8;

	// Personality constants
	const int NumIdeals = 6;
	const int NumBonds = 6;
	const int NumFlaws = 6;
	const int NumPersonalityTraits = 8;
	...
	const std::array<std::string, NumDwarfClanNames> DwarfClanNames = {
	...
	const std::array<std::string, NumDwarfFemaleNames> DwarfFemaleNames = {
	...
	const std::array<std::string, NumDwarfMaleNames> DwarfMaleNames = {
	...
	const std::array<std::string, NumElfFamilyNames> ElfFamilyNames = {
	...
	const std::array<std::string, NumElfFemaleNames> ElfFemaleNames = {
	...
	const std::array<std::string, NumElfMaleNames> ElfMaleNames = {
	...
	const std::array<std::string, NumCalishiteSurnames> CalishiteSurnames = {
		"Basha", "Dumein", "Hassan", "Khalid", "Mostana", "Pashar", "Rein"
	};

	const std::array<std::string, NumChondathanTethyrianSurnames> ChondathanTethyrianSurnames = {
		"Amblecrown", "Buckman", "Dundragon", "Evenwood", "Greycastle", "Tallstag"
	};

	const std::array<std::string, NumDamaranSurnames> DamaranSurnames = {
		"Bersk", "Bernin", "Dotsk", "Kulenov", "Marsk", "Nemetsk", "Shemov", "Starag"
	};

	const std::array<std::string, NumIlluskanSurnames> IlluskanSurnames = {
		"Brightwood", "Helder", "Hornraven", "Lackman", "Stormwind", "Windrivver"
	};

	const std::array<std::string, NumMulanSurnames> MulanSurnames = {
		"Ankhalah", "Anskuld", "Fezim", "Hahpet", "Nathandem", "Serpet", "Uuthrakt"
	};

	const std::array<std::string, NumRashemiSurnames> RashemiSurnames = {
		"Chergoba", "Dyernina", "Iltazyara", "Murnyethara", "Stayanoga", "Ulmokina"
	};

	const std::array<std::string, NumShouSurnames> ShouSurnames = {
		"Chien", "Huang", "Kao", "Kung", "Lao", "Ling", "Mei", "Pin", "Shin", "Sum", "Tan", "Wan"
	};

	const std::array<std::string, NumTuramiSurnames> TuramiSurnames = {
		"Agosto", "Astorio", "Calabra", "Domine", "Falone", "Marivaldi", "Pisacar", "Ramondo"
	};

	const std::array<std::string, NumCalishiteFemaleNames> CalishiteFemaleNames = {
		"Atala", "Ceidil", "Hama", "Jasmal", "Meilil", "Seipora", "Yasheria", "Zasheida"
	};

	const std::array<std::string, NumChondathanTethyrianFemaleNames> ChondathanTethyrianFemaleNames = {
		"Arveene", "Esvele", "Jhessail", "Kerri", "Lureene", "Mirir", "Rowan", "Shandri", "Tessele"
	};

	const std::array<std::string, NumDamaranFemaleNames> DamaranFemaleNames = {
		"Alethra", "Kara", "Katernin", "Mara", "Natali", "Olma", "Tana", "Zora"
	};

	const std::array<std::string, NumIlluskanFemaleNames> IlluskanFemaleNames = {
		"Amafrey", "Betha", "Cefrey", "Kethra", "Mara", "Olga", "Silifrey", "Westra"
	};

	const std::array<std::string, NumMulanFemaleNames> MulanFemaleNames = {
		"Arizima", "Chathi", "Nephis", "Nulara", "Murithi", "Sefris", "Thola", "Umara", "Zolis"
	};

	const std::array<std::string, NumRashemiFemaleNames> RashemiFemaleNames = {
		"Fyevarra", "Hulmarra", "Immith", "Imzel", "Nevarra", "Shevarra", "Tammith", "Yuldra"
	};

	const std::array<std::string, NumShouFemaleNames> ShouFemaleNames = {
		"Bai", "Chao", "Jia", "Lei", "Mei", "Qiao", "Shui", "Tai"
	};

	const std::array<std::string, NumTuramiFemaleNames> TuramiFemaleNames = {
		"Balama", "Dona", "Faila", "Jalana", "Luisa", "Marta", "Quara", "Selise", "Vonda"
	};

	const std::array<std::string, NumCalishiteMaleNames> CalishiteMaleNames = {
		"Aseir", "Bardeid", "Haseid", "Khemed", "Mehmen", "Sudeiman", "Zasheir"
	};

	const std::array<std::string, NumChondathanTethyrianMaleNames> ChondathanTethyrianMaleNames = {
		"Darvin", "Dorn", "Evendur", "Gorstag", "Grim", "Helm", "Malark", "Morn", "Randal", "Stedd"
	};

	const std::array<std::string, NumDamaranMaleNames> DamaranMaleNames = {
		"Bor", "Fodel", "Glar", "Grigor", "Igan", "Ivor", "Kosef", "Mival", "Orel", "Pavel", "Sergor"
	};

	const std::array<std::string, NumIlluskanMaleNames> IlluskanMaleNames = {
		"Ander", "Blath", "Bran", "Frath", "Geth", "Lander", "Luth", "Malcer", "Stor", "Taman", "Urth"
	};

	const std::array<std::string, NumMulanMaleNames> MulanMaleNames = {
		"Aoth", "Bareris", "Ehput-Ki", "Kethoth", "Mumed", "Ramas", "So-Kehur", "Thazar-De", "Urhur"
	};

	const std::array<std::string, NumRashemiMaleNames> RashemiMaleNames = {
		"Borivik", "Faurgar", "Jandar", "Kanithar", "Madislak", "Ralmevik", "Shaumar", "Vladislak"
	};

	const std::array<std::string, NumShouMaleNames> ShouMaleNames = {
		"An", "Chen", "Chi", "Fai", "Jiang", "Jun", "Lian", "Long", "Meng", "On", "Shan", "Shui", "Wen"
	};

	const std::array<std::string, NumTuramiMaleNames> TuramiMaleNames = {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> AcolyteIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> CharlatanIdeals = { {
		{"Chaotic", "Independence. I am a free spirit--no one tells me what to do."},
		{"Lawful", "Fairness. I never target people who can't afford to lose a few coins."},
		{"Good", "Charity. I distribute the money I acquire to the people who really need it."},
		{"Chaotic", "Creativity. I never run the same con twice."},
		{"Good", "Friendship. Material goods come and go.Bonds of friendship last forever."},
		{"Any", "Aspiration. I'm determined to make something of myself."}
	} };

	const std::array<std::pair<std::string, std::string>, NumIdeals> CriminalSpyIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> EntertainerGladiatorIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> FolkHeroIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> GuildArtisanMerchantIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals>  HermitIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> NobleKnightIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> OutlanderIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> SageIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> SailorPirateIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> SoldierIdeals = { {
	...
	const std::array<std::pair<std::string, std::string>, NumIdeals> UrchinIdeals = { {
	...
	const std::array<std::string, NumBonds> AcolyteBonds = {
	...
	const std::array<std::string, NumBonds> CharlatanBonds = {
	...
	const std::array<std::string, NumBonds> CriminalSpyBonds = {
	...
	const std::array<std::string, NumBonds> EntertainerGladiatorBonds = {
	...
	const std::array<std::string, NumBonds> FolkHeroBonds = {
	...
	const std::array<std::string, NumBonds> GuildArtisanMerchantBonds = {
	...
	const std::array<std::string, NumBonds> HermitBonds = {
	...
	const std::array<std::string, NumBonds> NobleKnightBonds = {
	...
	const std::array<std::string, NumBonds> OutlanderBonds = {
	...
	const std::array<std::string, NumBonds> SageBonds = {
		"It is my duty to protect my students.",
		"I have an ancient text that holds terrible secrets that must not fall into the wrong hands.",
		"I work to preserve a library, university, scriptorium, or monastery.",
		"My life's work is a series of tomes related to a specific field of lore.",
		"I've been searching my whole life for the answer to a certain question.",
		"I sold my soul for knowledge. I hope to do great deedsand win it back."
	};

	const std::array<std::string, NumBonds> SailorPirateBonds = {
	...
	const std::array<std::string, NumBonds> SoldierBonds = {
	...
	const std::array<std::string, NumBonds> UrchinBonds = {
	...
	const std::array<std::string, NumFlaws> AcolyteFlaws = {
	...
	const std::array<std::string, NumFlaws> CharlatanFlaws = {
	...
	const std::array<std::string, NumFlaws> CriminalSpyFlaws = {
	...
	const std::array<std::string, NumFlaws> EntertainerGladiatorFlaws = {
	...
	const std::array<std::string, NumFlaws> FolkHeroFlaws = {
	...
	const std::array<std::string, NumFlaws> GuildArtisanMerchantFlaws = {
	...
	const std::array<std::string, NumFlaws> HermitFlaws = {
	...
	const std::array<std::string, NumFlaws> NobleKnightFlaws = {
	...
	const std::array<std::string, NumFlaws> OutlanderFlaws = {
	...
	const std::array<std::string, NumFlaws> SageFlaws = {
	...
	const std::array<std::string, NumFlaws> SailorPirateFlaws = {
	...
	const std::array<std::string, NumFlaws> SoldierFlaws = {
	...
	const std::array<std::string, NumFlaws> UrchinFlaws = {
	...
	const std::array<std::string, NumPersonalityTraits> AcolytePersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> CharlatanPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> CriminalSpyPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> EntertainerGladiatorPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> FolkHeroPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> GuildArtisanMerchantPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> HermitPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> NobleKnightPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> OutlanderPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> SagePersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> SailorPiratePersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> SoldierPersonalityTraits = {
	...
	const std::array<std::string, NumPersonalityTraits> UrchinPersonalityTraits = {
		"I hid scraps of foodand trinkets away in my pockets.",
